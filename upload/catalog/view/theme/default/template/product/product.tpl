  ...
  <div class="row"><?php echo $column_left; ?>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-review">
              <form class="form-horizontal" id="form-review">
               ...
               <?php  /*  This is romoved OC 2 script review_guest */ ?>
   ...
   <div class="col-sm-12"> <label><b><?php echo $entry_captcha; ?></b></label></div>
    ...
    <br />   
               ...
               <?php  /*  This is romoved OC 2 end script review_guest */ ?>
        ...
        <div class="<?php echo $class; ?>">
          ...
          <div id="product">
            ...
            <?php } ?>
               ...
               <?php  /*  This is romoved OC 2 script recurring */ ?>

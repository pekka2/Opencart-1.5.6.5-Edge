<div class="buttons">
  ...
  <div class="right" style="padding-top:10px; width:30%;">
    <input type="button"  onclick="window.location = '<?php echo $action; ?>';" value="<?php echo $button_confirm; ?>" id="button-confirm" class="button" />
  </div>
</div>

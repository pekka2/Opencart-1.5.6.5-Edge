<h3><?php echo $heading_title; ?></h3>
  ...
  <?php
    if($position == 'column_left' || $position == 'column_right'){
                           $class = 'class="product-layout col-lg-12 col-md-12 col-sm-12 col-xs-12"';
                           $cssy = '';
                           $column = true;
                           $padding = '';
    }
    if($position == 'content_top' || $position == 'content_bottom'){
                       if($change){
                                      ...
                                      $class = 'class="product-layout col-lg-' . $lg . ' col-md-3 col-sm-' . $md . '  col-xs-12"';
                           $cssy = ' ' . $sy;
    }
?>
<div class="row">
    ...
    <div class="product-thumb transition">
      ...
      <div class="caption<?php echo $cssy;?>"<?php echo $padding;?>>
        ...
        <p><?php  
            ...
            if($description_status && $max > 0 || $status == false){             
                   for($i=0; $i<$c;$i++){

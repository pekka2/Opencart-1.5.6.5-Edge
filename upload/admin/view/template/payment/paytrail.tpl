      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-bank-transfer" class="form-horizontal">
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="paytrail_merchant_id" value="<?php echo $paytrail_merchant_id; ?>" placeholder="<?php echo $entry_merchant_id; ?>" id="input-merchant-id" class="form-control" />
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-merchant-secret"><?php echo $entry_merchant_secret; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="paytrail_merchant_secret" value="<?php echo $paytrail_merchant_secret; ?>" placeholder="<?php echo $entry_merchant_id; ?>" id="input-merchant-secret" class="form-control" />
                  <?php if ($error_merchant_id) { ?>
                  <div class="text-danger"><?php echo $error_merchant_id; ?></div>
                  <?php } ?>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="select-order_status"><?php echo $entry_order_status; ?></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="select-order_status"><?php echo $entry_order_failed_status; ?></label>
                <div class="col-sm-10">
                  <select name="paytrail_order_failed_status_id" id="select-order_status" class="form-control">
                 <?php foreach ($order_statuses as $order_status) { ?>
                 <?php if ($order_status['order_status_id'] == $paytrail_failed_order_status_id) { ?>
                 <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                 <?php } else { ?>
                 <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                <?php } ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="select-geo_zone_id"><?php echo $entry_geo_zone; ?></label>
                <div class="col-sm-10">
                  <select name="paytrail_geo_zone_id" id="select-geo_zone_id" class="form-control">
              <option value="0"><?php echo $text_all_zones; ?></option>
              <?php foreach ($geo_zones as $geo_zone) { ?>
                  <?php if ($geo_zone['geo_zone_id'] == $paytrail_geo_zone_id) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="paytrail_status" id="input-status" class="form-control">
                <?php if ($paytrail_status) { ?>
